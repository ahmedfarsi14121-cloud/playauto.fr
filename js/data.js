...
const VEHICLES_DB = {
  ...
  "Audi": [
    { model: "A1", from: 2010, to: 2026 },
    { model: "A2", from: 1999, to: 2005 },
    { model: "A3", from: 1996, to: 2026 },
    { model: "A4", from: 1994, to: 2026 },
    { model: "A5", from: 2007, to: 2026 },
    { model: "A6", from: 1994, to: 2026 },
    { model: "A7", from: 2010, to: 2026 },
    { model: "A8", from: 1994, to: 2026 },
    { model: "Q2", from: 2016, to: 2026 },
    { model: "Q3", from: 2011, to: 2026 },
    { model: "Q4 e-tron", from: 2021, to: 2026 },
    { model: "Q5", from: 2008, to: 2026 },
    { model: "Q7", from: 2005, to: 2026 },
    { model: "Q8", from: 2018, to: 2026 },
    { model: "TT", from: 1998, to: 2023 },
    { model: "e-tron", from: 2018, to: 2023 },
    { model: "e-tron GT", from: 2021, to: 2026 }
  ],
  "BMW": [
    { model: "Série 1", from: 2004, to: 2026 },
    { model: "Série 2", from: 2014, to: 2026 },
    { model: "Série 3", from: 1998, to: 2026 },
    { model: "Série 4", from: 2013, to: 2026 },
    { model: "Série 5", from: 2003, to: 2026 },
    { model: "Série 6", from: 2003, to: 2018 },
    { model: "Série 7", from: 2001, to: 2026 },
    { model: "Série 8", from: 2018, to: 2026 },
    { model: "X1", from: 2009, to: 2026 },
    { model: "X2", from: 2017, to: 2026 },
    { model: "X3", from: 2003, to: 2026 },
    { model: "X4", from: 2014, to: 2026 },
    { model: "X5", from: 1999, to: 2026 },
    { model: "X6", from: 2008, to: 2026 },
    { model: "X7", from: 2018, to: 2026 },
    { model: "Z4", from: 2002, to: 2026 },
    { model: "i3", from: 2013, to: 2022 },
    { model: "i4", from: 2021, to: 2026 },
    { model: "iX", from: 2021, to: 2026 },
    { model: "iX1", from: 2022, to: 2026 },
    { model: "iX3", from: 2020, to: 2026 }
  ],
  "BYD": [
  ...
  "Citroën": [
    { model: "C1", from: 2005, to: 2022 },
    { model: "C2", from: 2003, to: 2009 },
    { model: "C3", from: 2002, to: 2026 },
    { model: "C3 Aircross", from: 2017, to: 2026 },
    { model: "C3 Picasso", from: 2009, to: 2017 },
    { model: "C4", from: 2004, to: 2026 },
    { model: "C4 Cactus", from: 2014, to: 2021 },
    { model: "C4 Picasso", from: 2006, to: 2021 },
    { model: "C4 SpaceTourer", from: 2013, to: 2021 },
    { model: "C4 X", from: 2021, to: 2026 },
    { model: "C5", from: 2000, to: 2017 },
    { model: "C5 Aircross", from: 2018, to: 2026 },
    { model: "C5 X", from: 2021, to: 2026 },
    { model: "C6", from: 2005, to: 2012 },
    { model: "C8", from: 2002, to: 2014 },
    { model: "C-Elysée", from: 2012, to: 2026 },
    { model: "Berlingo", from: 1996, to: 2026 },
    { model: "Jumpy", from: 1994, to: 2026 },
    { model: "Jumper", from: 1994, to: 2026 },
    { model: "Nemo", from: 2007, to: 2015 }
  ],
  "Cupra": [
  ...
  "Ford": [
    { model: "Ka", from: 1996, to: 2016 },
    { model: "Fiesta", from: 1995, to: 2023 },
    { model: "Focus", from: 1998, to: 2025 },
    { model: "Mondeo", from: 1993, to: 2022 },
    { model: "Puma", from: 2019, to: 2026 },
    { model: "Kuga", from: 2008, to: 2026 },
    { model: "EcoSport", from: 2013, to: 2021 },
    { model: "Edge", from: 2015, to: 2019 },
    { model: "S-Max", from: 2006, to: 2023 },
    { model: "Galaxy", from: 1995, to: 2023 },
    { model: "C-Max", from: 2003, to: 2019 },
    { model: "B-Max", from: 2012, to: 2017 },
    { model: "Transit", from: 1965, to: 2026 },
    { model: "Transit Connect", from: 2002, to: 2026 },
    { model: "Transit Custom", from: 2012, to: 2026 },
    { model: "Ranger", from: 1998, to: 2026 },
    { model: "Mustang Mach-E", from: 2020, to: 2026 }
  ],
  "Genesis": [
  ...
  "Mercedes-Benz": [
    { model: "Classe A", from: 1997, to: 2026 },
    { model: "Classe B", from: 2005, to: 2025 },
    { model: "Classe C", from: 1993, to: 2026 },
    { model: "Classe E", from: 1993, to: 2026 },
    { model: "Classe S", from: 2005, to: 2026 },
    { model: "CLA", from: 2013, to: 2026 },
    { model: "CLS", from: 2004, to: 2023 },
    { model: "GLA", from: 2013, to: 2026 },
    { model: "GLB", from: 2019, to: 2026 },
    { model: "GLC", from: 2015, to: 2026 },
    { model: "GLE", from: 2015, to: 2026 },
    { model: "GLK", from: 2008, to: 2015 },
    { model: "GLS", from: 2016, to: 2026 },
    { model: "Classe V", from: 2014, to: 2026 },
    { model: "Vito", from: 1996, to: 2026 },
    { model: "Sprinter", from: 1995, to: 2026 },
    { model: "Citan", from: 2012, to: 2026 },
    { model: "SLK / SLC", from: 1996, to: 2020 }
  ],
  "MG": [
  ...
  "Opel": [
    { model: "Corsa", from: 1993, to: 2026 },
    { model: "Astra", from: 1991, to: 2026 },
    { model: "Insignia", from: 2008, to: 2022 },
    { model: "Meriva", from: 2003, to: 2017 },
    { model: "Zafira", from: 1999, to: 2019 },
    { model: "Mokka", from: 2012, to: 2026 },
    { model: "Crossland", from: 2017, to: 2026 },
    { model: "Grandland", from: 2017, to: 2026 },
    { model: "Combo", from: 1994, to: 2026 },
    { model: "Vivaro", from: 1996, to: 2026 },
    { model: "Movano", from: 1998, to: 2026 },
    { model: "Adam", from: 2013, to: 2019 },
    { model: "Karl", from: 2015, to: 2019 },
    { model: "Agila", from: 2000, to: 2014 },
    { model: "Antara", from: 2006, to: 2015 },
    { model: "Signum", from: 2003, to: 2008 },
    { model: "Vectra", from: 1995, to: 2008 },
    { model: "Tigra", from: 1994, to: 2009 }
  ],
  "Peugeot": [
    { model: "106", from: 1991, to: 2003 },
    { model: "107", from: 2005, to: 2014 },
    { model: "108", from: 2014, to: 2021 },
    { model: "206", from: 1998, to: 2012 },
    { model: "207", from: 2006, to: 2014 },
    { model: "208", from: 2012, to: 2026 },
    { model: "2008", from: 2013, to: 2026 },
    { model: "301", from: 2012, to: 2026 },
    { model: "307", from: 2001, to: 2008 },
    { model: "308", from: 2007, to: 2026 },
    { model: "3008", from: 2009, to: 2026 },
    { model: "407", from: 2004, to: 2011 },
    { model: "408", from: 2010, to: 2026 },
    { model: "5008", from: 2009, to: 2026 },
    { model: "508", from: 2010, to: 2026 },
    { model: "Partner", from: 1996, to: 2026 },
    { model: "Rifter", from: 2018, to: 2026 },
    { model: "Expert", from: 1995, to: 2026 },
    { model: "Traveller", from: 2016, to: 2026 },
    { model: "RCZ", from: 2010, to: 2015 }
  ],
  "Porsche": [
  ...
  "Renault": [
    { model: "Twingo", from: 1993, to: 2026 },
    { model: "Clio", from: 1990, to: 2026 },
    { model: "Captur", from: 2013, to: 2026 },
    { model: "Mégane", from: 1995, to: 2026 },
    { model: "Scénic", from: 1996, to: 2026 },
    { model: "Kadjar", from: 2015, to: 2022 },
    { model: "Austral", from: 2022, to: 2026 },
    { model: "Talisman", from: 2015, to: 2022 },
    { model: "Laguna", from: 1994, to: 2015 },
    { model: "Espace", from: 1984, to: 2026 },
    { model: "Kangoo", from: 1997, to: 2026 },
    { model: "Trafic", from: 1980, to: 2026 },
    { model: "Master", from: 1980, to: 2026 },
    { model: "Zoe", from: 2012, to: 2024 },
    { model: "Arkana", from: 2021, to: 2026 },
    { model: "Symbioz", from: 2023, to: 2026 },
    { model: "Koleos", from: 2008, to: 2026 },
    { model: "Fluence", from: 2009, to: 2016 },
    { model: "Modus", from: 2004, to: 2012 }
  ],
  "Saab": [
  ...
  "Toyota": [
    { model: "Aygo", from: 2005, to: 2022 },
    { model: "Aygo X", from: 2022, to: 2026 },
    { model: "Yaris", from: 1999, to: 2026 },
    { model: "Yaris Cross", from: 2021, to: 2026 },
    { model: "Corolla", from: 2001, to: 2026 },
    { model: "Auris", from: 2006, to: 2018 },
    { model: "C-HR", from: 2016, to: 2026 },
    { model: "RAV4", from: 1994, to: 2026 },
    { model: "Prius", from: 1997, to: 2026 },
    { model: "Avensis", from: 1997, to: 2018 },
    { model: "Camry", from: 2018, to: 2026 },
    { model: "Land Cruiser", from: 2002, to: 2026 },
    { model: "Hilux", from: 2005, to: 2026 },
    { model: "Verso", from: 2004, to: 2018 },
    { model: "ProAce", from: 2016, to: 2026 },
    { model: "bZ4X", from: 2022, to: 2026 }
  ],
  "Volkswagen": [
    { model: "up!", from: 2011, to: 2023 },
    { model: "Polo", from: 2001, to: 2026 },
    { model: "Golf", from: 1997, to: 2026 },
    { model: "Passat", from: 1996, to: 2026 },
    { model: "Arteon", from: 2017, to: 2026 },
    { model: "Scirocco", from: 2008, to: 2017 },
    { model: "Beetle", from: 1998, to: 2019 },
    { model: "CC", from: 2008, to: 2017 },
    { model: "Tiguan", from: 2007, to: 2026 },
    { model: "Touran", from: 2003, to: 2023 },
    { model: "Touareg", from: 2002, to: 2026 },
    { model: "T-Roc", from: 2017, to: 2026 },
    { model: "T-Cross", from: 2019, to: 2026 },
    { model: "Taigo", from: 2021, to: 2026 },
    { model: "Sharan", from: 1995, to: 2022 },
    { model: "Caddy", from: 2004, to: 2026 },
    { model: "Transporter / Multivan", from: 2003, to: 2026 },
    { model: "Amarok", from: 2010, to: 2026 },
    { model: "ID.3", from: 2020, to: 2026 },
    { model: "ID.4", from: 2020, to: 2026 },
    { model: "ID.5", from: 2021, to: 2026 },
    { model: "ID.7", from: 2023, to: 2026 }
  ],
  "Volvo": [
